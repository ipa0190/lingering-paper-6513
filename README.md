...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/lingering-paper-6513)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/lingering-paper-6513
```

A live public deployment of this template is available at [https://lingering-paper-6513.templates.workers.dev](https://lingering-paper-6513.templates.workers.dev)
